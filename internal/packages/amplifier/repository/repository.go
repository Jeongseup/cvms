...
import (
	...
	"github.com/cosmostation/cvms/internal/packages/amplifier/model"
	"github.com/pkg/errors"
	"github.com/uptrace/bun"
)

var IndexName = "amplifier_verifier"
...
func NewRepository(indexerDB common.IndexerDB, sqlTimeout time.Duration) AmplifierIndexerRepository {
	...
	return AmplifierIndexerRepository{sqlTimeout, indexerDB.DB, metarepo}
}

func (repo *AmplifierIndexerRepository) InsertValidatorExtensionVoteList(
	chainInfoID int64,
	indexPointerHeight int64,
	AmplifierVoteList []model.AmplifierVote,
) error {
